...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:testMiniAOD.root')
)
...
process.NtupleAnalyzer = cms.EDAnalyzer("NtupleAnalyzer",
    ...
    PFElectronTag = cms.untracked.InputTag("slimmedElectrons"),
    PFJetTag = cms.untracked.InputTag("slimmedJets"),
    PFMETTag = cms.untracked.InputTag("slimmedMETs"),
    PFMuonTag = cms.untracked.InputTag("slimmedMuons"),
    PFTauTag = cms.untracked.InputTag("slimmedTaus"),
...
process.NtupleAnalyzerTemplate = cms.EDAnalyzer("NtupleAnalyzer",
    ElectronTag = cms.untracked.InputTag("selectedPatElectrons"),
    JetTag = cms.untracked.InputTag("selectedPatJets"),
    METTag = cms.untracked.InputTag("patMETs"),
    METThreshold = cms.double(0),
