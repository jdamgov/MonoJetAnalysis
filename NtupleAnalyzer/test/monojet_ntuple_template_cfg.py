...
iFileMCFull    =  '/store/mc/RunIISpring15DR74/TT_Mtt-700to1000_TuneCUETP8M1_13TeV-powheg-pythia8/MINIAODSIM/Asympt25ns_MCRUN2_74_V9_ext1-v1/00000/16607CF9-3119-E511-8018-00259029ED22.root'
...
#    process.p5  = cms.Path(process.CSCTightHaloFilter) #Loose (obsolete)
...
#        process.p13 = cms.Path(process.hcalfilter)
#    else:
#        process.p13 = cms.Path(process.hltHighLevel)
#    process.p14 = cms.Path(process.checkHLTHighLevel1)
#    process.p15 = cms.Path(process.checkHLTHighLevel2)
#    process.p16 = cms.Path(process.checkHLTHighLevel3)
#    process.p17 = cms.Path(process.checkHLTHighLevel4)
#    process.p18 = cms.Path(process.checkHLTHighLevel5)
#    process.p19 = cms.Path(process.checkHLTHighLevel6)
#else:
#    process.p2  = cms.Path(process.hltHighLevel)
#    process.p3  = cms.Path(process.hltHighLevel)
#    process.p4  = cms.Path(process.hltHighLevel)
#    process.p5  = cms.Path(process.hltHighLevel)
#    process.p6  = cms.Path(process.hltHighLevel)
#    process.p7  = cms.Path(process.hltHighLevel)
#    process.p8  = cms.Path(process.hltHighLevel)
#    process.p9  = cms.Path(process.hltHighLevel)
#    process.p10 = cms.Path(process.hltHighLevel)
#    process.p11 = cms.Path(process.hltHighLevel)
#    process.p12 = cms.Path(process.hltHighLevel)
#    process.p13 = cms.Path(process.hltHighLevel)
#    process.p14 = cms.Path(process.checkHLTHighLevel1)
#    process.p15 = cms.Path(process.checkHLTHighLevel2)
#    process.p16 = cms.Path(process.checkHLTHighLevel3)
